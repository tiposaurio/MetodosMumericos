...
public class VentanaPuntoFijo extends MuFrame {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -4888394810315737979L;
	private static final VentanaPuntoFijo instance = new VentanaPuntoFijo();
	...
	private VentanaPuntoFijo() {
		super();
	}

	public static VentanaPuntoFijo getInstance() {
		return instance;
	}
