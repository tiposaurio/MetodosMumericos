...
public class VentanaBiseccion extends MuFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9108795772120080181L;
	private static final VentanaBiseccion instance = new VentanaBiseccion();
	...
	protected VentanaBiseccion() {
		super();
		//
	}

	public static VentanaBiseccion getInstance() {
		return instance;
	}
			...
			public void botonPressedEvent(MuBotonEvent e) {
				if (e.getSource() == empezar) {
					if (!campoA.getText().isEmpty()
						...
						String[] result =MetodosNumericos.metodoBiseccion(f, Double
								.parseDouble(campoA.getText()), Double
								.parseDouble(campoB.getText()), Integer
